...
class StoreClientRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cedula'=>'string|required|unique:clients|min:6|max:8',
            'rif'=>'string|required|unique:clients|min:9|max:11',
            'address'=>'string|required|max:255',
            'phone'=>'string|nullable|unique:clients|max:11',
            'email'=>'string|email|unique:clients|max:255|nullable',
    ...
    public function messages(){
        return [
            ...
            'rif.max'=>'Solo se permite 250 caracteres',
            ...
            'phone.min'=>'Se requiere 11 caracteres',
